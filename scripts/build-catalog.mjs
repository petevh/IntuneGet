 ...
 *     OUT=/data/catalog.local.sqlite node --input-type=module < scripts/build-catalog.mjs
 *
 * This script lives in the IntuneGet source repo (scripts/, beside the upstream
 * build-catalog-snapshot.mjs whose schema it mirrors). The homelab cron wrapper
 * that drives it — refresh-catalog.sh — stays in the docker-homelab repo and
 * pipes this file in from the source checkout.
 *
